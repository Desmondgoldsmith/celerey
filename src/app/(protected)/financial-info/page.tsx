  ...
  const validateCurrentStep = useCallback((): boolean => {
    ...
    switch (currentStepIndex) {
      ...
      case 1: // Income validation
        return (
          parseFloat(data.activeIncome.bonuses || "0") >= 0 &&
          parseFloat(data.activeIncome.commissions || "0") >= 0 &&
          parseFloat(data.activeIncome.otherIncome || "0") >= 0 &&
          parseFloat(data.activeIncome.salary || "0") >= 0
        );
